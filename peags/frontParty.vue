    ...
    <ul class="clearfix nav1">
      ...
      <li style="width: 29%">
        <el-menu class="el-menu-demo"
                 mode="horizontal"
                 text-color="#fff"
                 active-text-color="#f4e925" style=" height:9vh;">
...
<div class="box"
          ...
          <div class="boxnav"
               style="height:20vh;">
            <div style="width: 100%; height:18vh;position:absolute;bottom:0;"
                 id="echart12"></div>
          </div>
        </div>
      </li>
      ...
      <li style="width: 14.5%"
        ...
        <div class="box l-box">
          ...
          <div class="boxnav"
               style="20vh;">
            <div style="float: left; width: 100%; height: 18vh;"
                 id="echart5"></div>
          </div>
        </div>
      </li>
      ...
      <li style="width: 14.5%"
        ...
        <div class="box l-box">
          ...
          <div class="boxnav"
               style="20vh;">
            <div style="float: left; width: 100%; height: 19vh;"
                 id="echart6"></div>
          </div>
        </div>
      </li>
      ...
      <li style="width: 14.5%"
        ...
        <div class="box l-box">
          ...
          <div class="boxnav"
               style="20vh;">
            <div style="float: left; width: 100%; height: 20vh;"
                 id="echart4"></div>
          </div>
        </div>
      </li>
      ...
      <li style="width: 29%"
        ...
        <div class="box"
          ...
          <div class="boxnav"
               style="height:20vh;">
            <div style="float:left; width: 450px; height: 20vh;"
                 id="echart13"></div>
          </div>
        </div>
      </li>
...
.tit01:before {
  ...
  width: 6px;
  height: 6px;
  background: rgba(20, 214, 255, 0.9);
  box-shadow: 0 0 5px rgba(20, 214, 255, 0.9);
  border-radius: 10px;
  left: 10px;
  top: 18px;
}
...
.box:before {
  ...
  box-shadow: 0 0 5px rgba(131, 189, 207, 1);
  opacity: 0.6;
}
