  ...
  <adapter>
    ...
    <div class="mainbox content">
      <ul class="clearfix nav1">
        <li style="width: 24%;"> 
          <div class="box">
            <div class="tit" style="height:13vh">
              人员检索
            ...
            <div class="boxnav" style="height: 73vh;margin-bottom:20%">
              <el-scrollbar wrap-class="scrollbar-wrapper">
                <el-menu default-active="2" class="el-menu-vertical-demo element" :unique-opened="false" style="overflow-y: scroll;height: 110%;">
                  <el-submenu index="1">
                    <template slot="title">
                      <span>人员检索结果</span>
                    </template>
                    <el-scrollbar class="element" style="height: 200px;z-index: 100;overflow: scroll;">
                  ...
                  <el-submenu index="2">
                    ...
                    <el-submenu v-for="(value,key) in partyList" :key="key" :index="`submenu-${key}`">
                      ...
                      <el-scrollbar style="height: 200px;z-index: 100;overflow: scroll;">
                          <el-menu-item-group style="height:120px;">
        ...
        <li style="width: 76%">
          <div class="box">
            <div class="boxnav mapc" style="height:86vh;margin-bottom:80px; position: relative">
              <div class="map" id="map">
                <!--人物照片和个人信息展示-->
                <div class="box personInformation" style="height:125px;">
                  <div class="person">
                ...
                <div class="track">
                  ...
                  <div class="appointment">
                    ...
                    <div class="middlebox color5 text-break element" style="width:100%;height:12%;position:absolute" v-html="info.positionAxis"></div>
                  </div>
                  <div class="activity">
                    <h3>活动轴</h3>
                    <el-divider></el-divider>
                    <div class="middlebox color5 text-break element"  style="width:100%;height:12%;position:absolute"  v-html="info.activeAxis"></div>
                  </div>
                  <div class="award">
                    <h3>获奖轴</h3>
                    <el-divider></el-divider>
                    <div class="middlebox color5 text-break element"  style="width:100%;height:12%;position:absolute" v-html="info.awardAxis"></div>
                  </div>
                </div>
              </div>
            </div>
