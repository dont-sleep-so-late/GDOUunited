...
export default {
    ...
    methods: {
        inData() {
            axios.get(`http://localhost:9113/service/servicelog/logReport/getLogDetailByTime?dateType=7`).then((res) => {
        ...
        initChart() {
            axios.get(`http://localhost:9113/service/servicelog/logReport/getLoginLogByTime?dateType=7`).then((res) => {
        ...
        initUsepie() {
            axios.get(`http://localhost:9113/service/servicelog/logReport/getOperationLogByTime?dateType=7`).then((res) => {
        ...
        initBehavior() {
            axios.post(`http://localhost:9113/service/servicelog/logReport/getOperationTypeByTime?dateType=7`).then((res)=>{
