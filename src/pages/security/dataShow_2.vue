...
export default {
    ...
    methods: {
        inData() {
            axios.get(`http://localhost:9113/service/servicelog/logReport/getLogDetailByTime?dateType=30`).then((res) => {
        ...
        initChart() {
            axios.get(`http://localhost:9113/service/servicelog/logReport/getLoginLogByTime?dateType=30`).then((res) => {
        ...
        initUsepie() {
            axios.get(`http://localhost:9113/service/servicelog/logReport/getOperationLogByTime?dateType=30`).then((res) => {
        ...
        initTrend() {
            axios.get(`http://localhost:9113/service/servicelog/logReport/getTendencyOfLoginByTime?dateType=30`).then((res) => {
                ...
                const option = {
                    ...
                    xAxis: {
                        type: 'category',
                        data: [res.data.data[0].time , res.data.data[4].time , res.data.data[8].time , res.data.data[12].time , res.data.data[16].time , res.data.data[20].time , res.data.data[24].time , res.data.data[29].time],
                        axisLabel: {
                    ...
                    series: [
                        {
                            data: [res.data.data[0].count , res.data.data[4].count , res.data.data[8].count , res.data.data[12].count , res.data.data[16].count , res.data.data[20].count , res.data.data[24].count , res.data.data[29].count],
                            type: 'line',
                            smooth: true,
                            lineStyle: {
                                color: '#64aedf'
        ...
        initBehavior() {
            axios.post(`http://localhost:9113/service/servicelog/logReport/getOperationTypeByTime?dateType=30`).then((res)=>{
