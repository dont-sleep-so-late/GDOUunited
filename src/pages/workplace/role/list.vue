  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="操作" width="200" align="center">
        <template slot-scope="scope">
          <router-link :to="'/workplace/role/distribution/'+scope.row.id">
            <el-button type="info" size="mini" icon="el-icon-info" v-if="hasPerm('role.acl')"></el-button>
          </router-link>
          <router-link :to="'/workplace/role/update/'+scope.row.id">
...
export default {
  ...
  methods: {
    ...
    addUser(){
      this.$router.push({ path: '/workplace/role/add' })
    },
    ...
    removeDataById(id) {
      // debugger
      this.$confirm('此将永久删除该记录, 是否继续?', '提示', {
