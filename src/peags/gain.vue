<template>
  <div class="mainbox">
    <ul class="clearfix nav1">
      <li style="width: 50%">
        <gain_card name="教学科研成果展示" scrollIndex="sci" :photoList="photoList1" :newsList="newsList1" >
        </gain_card>
      </li>

      <li style="width: 50%">
        <gain_card  name="统战成果展示" scrollIndex="work" :photoList="photoList2" :newsList="newsList2"> 
        </gain_card>
      </li>
    </ul>
  </div>
